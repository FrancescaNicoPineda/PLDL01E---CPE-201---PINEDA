...
class Employee:
    ...
    #initializaion or constructor method of
    def __init__(self):
        #class Employee
    ...
    def emp_salary_computation(self):
        ...
        self.overtime_pay = self.emp_rate_per_hour * self.emp_hour_overtime
        self.emp_gross_earnings = self.basic_pay + self.overtime_pay + self.hononarium_pay
    ...
    def emp_sss_contribution(self):
        sss_brackets = [
            ...
            (24250, 24749.99, 900.00),
            (24750, float('inf'), 900.00),
        ]

        self.sss_contribution = 0.00

        # Loop through the SSS brackets to find the applicable contribution
    ...
    def emp_philhealth_contribution(self):
        #setting condition in getting philhealth contribution
    ...
    def emp_tax_contribution(self):
        ...
        for bracket in tax_brackets:
            if bracket[0] <= self.emp_gross_earnings < bracket[1]:
                self.tax_contribution = ((self.emp_gross_earnings - bracket[0]) * bracket[2] + bracket[3])
                break
